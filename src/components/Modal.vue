...
const agregarGasto = () => {
  ...
  // Validar no gastar mas de lo disponible
  if (id) {
...
<template>
  <div class="modal">
    ...
    >
      <form class="nuevo-gasto" v-on:submit.prevent="agregarGasto">
...
.nuevo-gasto input[type="button"]:hover {
